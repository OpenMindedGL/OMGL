...
int init(){
  ...
  GLfloat a = static_cast<GLfloat>(((rand() % 400) - 200) / 100.0f);
  gettimeofday(&random_y, NULL);
  srand(random_y.tv_usec);  
  GLfloat b = static_cast<GLfloat>(((rand() % 400) - 200) / 100.0f);
  gettimeofday(&random_y, NULL);
  srand(random_y.tv_usec);  
  GLfloat c = static_cast<GLfloat>(((rand() % 400) - 200) / 100.0f);
  gettimeofday(&random_y, NULL);
  srand(random_y.tv_usec);  
  GLfloat a1 = static_cast<GLfloat>(((rand() % 400) - 200) / 100.0f);
  gettimeofday(&random_y, NULL);
  srand(random_y.tv_usec);  
  GLfloat b1 = static_cast<GLfloat>(((rand() % 400) - 200) / 100.0f);
  gettimeofday(&random_y, NULL);
  srand(random_y.tv_usec);  
  GLfloat c1 = static_cast<GLfloat>(((rand() % 400) - 200) / 100.0f);
  ...
  for (int i = 0; i < 50600; i++){
    ...
    g_vertex_buffer_data[(i*3) + 1] = (a * (g_vertex_buffer_data[(i*3)] * g_vertex_buffer_data[(i*3)]) +
                                      b * (g_vertex_buffer_data[(i*3)]) + c) *
                                      (a1 * (g_vertex_buffer_data[(i*3) + 2] * g_vertex_buffer_data[(i*3) + 2]) +
                                      b1 * (g_vertex_buffer_data[(i*3) + 2]) + c1);
  }
